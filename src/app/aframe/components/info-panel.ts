    ...
    if ('undefined' === typeof AFRAME.components['info-panel']) {
      AFRAME.registerComponent('info-panel', {
        ...
        createInfoPanel: function () {
          ...
          entityEl.innerHTML = `
        <a-plane class="clickable" id="panelCloseBtn-` + this.data + `" color="#f41010"  position="0 -0.810 0.003" geometry="height: 0.090; width: 0.210"><a-text position="-0.063 0 0.001" width="0.950" color="#FFFFFF" value="Chiudi" ><a-text></a-plane>
