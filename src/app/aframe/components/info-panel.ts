    ...
    if ('undefined' === typeof AFRAME.components['info-panel']) {
      AFRAME.registerComponent('info-panel', {
        ...
        createInfoPanel: function () {
          ...
          entityEl.innerHTML = `
        <a-plane class="clickable" id="panelCloseBtn-` + this.data + `" color="#f41010"  position="0 -0.810 0.003" geometry="height: 0.100; width: 0.300"><a-text position="-0.095 0 0.001" width="1.2" color="#FFFFFF" value="CHIUDI" ><a-text></a-plane>
