...
export class GalleryService {
  ...
  private positions: Positions[] = [
    ...
    {id: 'r1-r2', name: 'ROOM 1 - Right 2', occupied: false},
    {id: 'r1-r3', name: 'ROOM 1 - Right 3', occupied: false},
    ...
    {id: 'r2-r2', name: 'ROOM 2 - Right 2', occupied: false},
    {id: 'r2-r3', name: 'ROOM 2 - Right 3', occupied: false},
    ...
    {id: 'r3-r2', name: 'ROOM 3 - Right 2', occupied: false},
    {id: 'r3-r3', name: 'ROOM 3 - Right 3', occupied: false},
  ]
